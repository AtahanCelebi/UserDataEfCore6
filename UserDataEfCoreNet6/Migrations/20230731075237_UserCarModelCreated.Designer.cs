...
namespace UserDataEfCoreNet6.Migrations
{
    ...
    [Migration("20230731075237_UserCarModelCreated")]
    partial class UserCarModelCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarUser", b =>
                {
                    b.HasOne("UserDataEfCoreNet6.Data.Car", null)
                        .WithMany()
                        .HasForeignKey("CarsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UserDataEfCoreNet6.Data.User", null)
                        .WithMany()
