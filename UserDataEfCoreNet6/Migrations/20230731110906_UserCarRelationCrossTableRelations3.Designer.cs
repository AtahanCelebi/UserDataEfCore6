...
namespace UserDataEfCoreNet6.Migrations
{
    ...
    [Migration("20230731110906_UserCarRelationCrossTableRelations3")]
    partial class UserCarRelationCrossTableRelations3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserDataEfCoreNet6.Data.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserDataEfCoreNet6.Data.UserCar", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UserDataEfCoreNet6.Data.UserCar", b =>
                {
                    b.HasOne("UserDataEfCoreNet6.Data.Car", "Car")
                        .WithMany("UserCars")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
